...
set CFLAGS=-nologo  -FC -WX -W4 -wd4731 -wd4201 -wd4514 -wd4100 -wd4505 -wd4189^
...
del *.pdb
cl %CFLAGS% /LD /I..\iaca-win64\ ..\code\game.cpp  /link %LFLAGS% /INCREMENTAL:NO /EXPORT:GameEngine
